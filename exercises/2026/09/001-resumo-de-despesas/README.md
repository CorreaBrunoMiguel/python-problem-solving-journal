...
Esta entrega em script está organizada em:
...
A nomenclatura acima foi adotada na segunda entrega; a tentativa 01 permanece no histórico com o arquivo `001_resumo_despesas.py`.
